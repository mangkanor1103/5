            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <a style="color: #28a745; font-size: 18px; text-decoration: none;">Sunny Prakash Tiwari</a>
                            <h4 style="color: #28a745;">+917785068889</h4>
                            <h4 style="color: #28a745;">sunnygkp10@gmail.com</h4>
                            <h4 style="color: #28a745;">Kamla Nehru Institute Of Technology, Sultanpur</h4>
                        </div>
                    </div>
                </div>
            </div>
